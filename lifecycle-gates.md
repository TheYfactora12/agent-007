...
**Owner agents:** Software Architect, InfoSec Risk Officer  
**Required artifacts:**
- Scope definition
...
**Owner agents:** Software Architect, Security Engineer, DevOps Automator  
**Required artifacts:**
...
**Owner agents:** Evidence Collector, Reality Checker, Accessibility Auditor, InfoSec Risk Officer  
**Required artifacts:**
...
**Owner agents:** Model Risk Governance Lead (if AI features deployed), InfoSec Risk Officer  
**Required artifacts:**
